...
return [
    ...
    */
    ...
    'gt'                   => [
        ...
        'string'  => 'Le texte doit Kontenir plus de :value KaraKtères.',
    ...
    'gte'                  => [
        ...
        'string'  => 'Le texte doit Kontenir au moins :value KaraKtères.',
    ...
    'max'                  => [
        ...
        'string'  => 'Le texte ne peut Kontenir plus de :max KaraKtères.',
    ...
    'min'                  => [
        ...
        'string'  => 'Le texte doit Kontenir au moins :min KaraKtères.',
        'array'   => 'Le tableau doit Kontenir au moins :min éléments.',
    ],
    'multiple_of'          => 'La valeur doit être un multiple de :value',
    'not_in'               => "Le champ séleKtionné n'est pas valide.",
    'not_regex'            => "Le format du champ n'est pas valide.",
    'numeric'              => 'Ce champ doit Kontenir un nombre.',
    'password'             => 'Le mot de passe est inKorrect',
    ...
    */
    ...
    'attributes' => [
        ...
        'password_Konfirmation' => 'Konfirmation du mot de passe',
        'city'                  => 'ville',
        'country'               => 'pays',
        'address'               => 'adresse',
        'phone'                 => 'téléphone',
