...
return [
    ...
    */
    ...
    'accepted'             => 'Ce champ doit être aKcepté.',
    ...
    'alpha'                => 'Ce champ doit Kontenir uniKement des lettres',
    'alpha_dash'           => 'Ce champ doit Kontenir uniKement des lettres, des chiffres et des tirets.',
    'alpha_num'            => 'Ce champ doit Kontenir uniKement des chiffres et des lettres.',
    ...
    'between'              => [
        'numeric' => 'La valeur doit être Komprise entre :min et :max.',
        'file'    => 'La taille du fichier doit être Komprise entre :min et :max kilo-octets.',
        'string'  => 'Le texte doit Kontenir entre :min et :max KaraKtères.',
        'array'   => 'Le tableau doit Kontenir entre :min et :max éléments.',
    ],
    'boolean'              => 'Ce champ doit être vrai ou faux.',
    'confirmed'            => 'Le champ de Konfirmation ne Korrespond pas.',
    'date'                 => "Ce n'est pas une date valide.",
    'date_equals'          => 'La date doit être égale à :date.',
    'date_format'          => 'Ce champ ne Korrespond pas au format :format.',
    'different'            => 'Cette valeur doit être différente de :other.',
    'digits'               => 'Ce champ doit Kontenir :digits chiffres.',
    'digits_between'       => 'Ce champ doit Kontenir entre :min et :max chiffres.',
    'dimensions'           => "La taille de l'image n'est pas Konforme.",
    ...
    'exists'               => 'Ce champ séleKtionné est invalide.',
    ...
    'gt'                   => [
        ...
        'string'  => 'Le texte doit Kontenir plus de :value caractères.',
        'array'   => 'Le tableau doit Kontenir plus de :value éléments.',
    ],
    'gte'                  => [
        ...
        'string'  => 'Le texte doit Kontenir au moins :value caractères.',
        'array'   => 'Le tableau doit Kontenir au moins :value éléments.',
    ],
    ...
    'json'                 => 'Ce champ doit être un doKument JSON valide.',
    'lt'                   => [
        'numeric' => 'La valeur doit être inférieure à :value.',
        'file'    => 'La taille du fichier doit être inférieure à :value kilo-octets.',
        'string'  => 'Le texte doit Kontenir moins de :value KaraKtères.',
        'array'   => 'Le tableau doit Kontenir moins de :value éléments.',
    ],
    'lte'                  => [
        ...
        'string'  => 'Le texte doit Kontenir au plus :value KaraKtères.',
        'array'   => 'Le tableau doit Kontenir au plus :value éléments.',
    ],
    'max'                  => [
        'numeric' => 'La valeur ne peut être supérieure à :max.',
        'file'    => 'La taille du fichier ne peut pas dépasser :max kilo-octets.',
        'string'  => 'Le texte ne peut Kontenir plus de :max caractères.',
        'array'   => 'Le tableau ne peut Kontenir plus de :max éléments.',
    ],
    ...
    'min'                  => [
        ...
        'string'  => 'Le texte doit Kontenir au moins :min caractères.',
        'array'   => 'Le tableau doit Kontenir au moins :min éléments.',
    ],
    ...
    'required_if'          => 'Ce champ est obligatoire Kand la valeur de :other est :value.',
    'required_unless'      => 'Ce champ est obligatoire sauf si :other est :values.',
    'required_with'        => 'Ce champ est obligatoire Kand :values est présent.',
    'required_with_all'    => 'Ce champ est obligatoire Kand :values sont présents.',
    'required_without'     => "Ce champ est obligatoire Kand :values n'est pas présent.",
    'required_without_all' => "Ce champ est requis Kand auKun de :values n'est présent.",
    'same'                 => 'Ce champ doit être identiKe à :other.',
    'size'                 => [
        'numeric' => 'La valeur doit être :size.',
        'file'    => 'La taille du fichier doit être de :size kilo-octets.',
        'string'  => 'Le texte doit Kontenir :size KaraKtères.',
        'array'   => 'Le tableau doit Kontenir :size éléments.',
    ],
    'starts_with'          => 'Ce champ doit Kommencer avec une des valeurs suivantes : :values',
    'string'               => 'Ce champ doit être une chaîne de KaraKtères.',
